...
const Icon = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }: IconProps) => {
   ...
   return (
       <span className={`icon inline-block relative top-[2px] ${classes}`} title={title}>
         ...
         {type === 'upload'
            && <svg {...xmlnsProps} fill="none" width={size} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke={color}>
         ...
         {type === 'backlink'
            && <svg enable-background="new 0 0 141.732 141.732" {...xmlnsProps} width={size} viewBox="0 0 141.732 141.732">
